...
import {
  ...
  Icon, TablePagination, Dialog, DialogTitle, DialogContent, DialogActions, TableContainer, Grid, InputAdornment, FormControl, Tooltip, TextField, TableSortLabel, InputLabel, Select, MenuItem, FormHelperText, Chip
} from "@material-ui/core";
import ConfirmationDialog from "components/matx/ConfirmationDialog";
import { ValidatorForm } from "react-material-ui-form-validator";
import { connect } from "react-redux";
import { PhoneIphone, Email, Person, Search,Error } from '@material-ui/icons';
              ...
              >
                ...
                <DialogActions className="p-0" style={{ display: "block" }}>
                  <div className="flex flex-middle flex-space-between">
                    <div>
                    <Chip variant="outlined"  style={{color : red[500]}} label="Password will generated by The System" icon={<Error style={{color : red[500]}}  />} />
